...
testthat::test_that("resolver returns zh/en rows", {
  en <- resolve_guide_annotation("xlsx_file", lang = "en", app_version = "1.0.0")
  zh <- resolve_guide_annotation("xlsx_file", lang = "zh", app_version = "1.0.0")
...
testthat::test_that("resolver filters by status and version", {
  inactive <- resolve_guide_annotation("graph_fh_display", lang = "en", app_version = "1.0.0")
  testthat::expect_equal(nrow(inactive), 0)

  active <- resolve_guide_annotation("export_pdf", lang = "en", app_version = "1.0.0")
...
testthat::test_that("resolver unsupported language falls back to english", {
  hit <- resolve_guide_annotation("energy_unit", lang = "fr", app_version = "1.0.0")
