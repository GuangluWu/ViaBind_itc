...
testthat::test_that("home_detect_import_type resolves by extension and naming rule", {
  ...
  testthat::expect_equal(home_detect_import_type("abc.nitc"), "itc")
  testthat::expect_equal(home_detect_import_type("abc.csc"), "itc")
  testthat::expect_equal(home_detect_import_type("abc.xml"), "itc")
